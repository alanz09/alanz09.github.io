    ...
    svg.append("text")
      ...
      .on("click", function(){
        ...
        var active   = blueLine.active ? false : true,
          ...
          newStroke = active ? "grey" : "blue";
          noOpacity = active ? 0.7 : 0,
          noStroke = active ? "grey" : "white";
        // Hide or show the elements
        d3.select("#blueLine").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#honduras").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#haiti").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#cuba").style("opacity", newOpacity).style("stroke", newStroke);
        // Other countries
        d3.select("#redLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#cambodia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#china").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#indonesia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#northKorea").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#laos").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#vietnam").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#orangeLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#azerbaijan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#belarus").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#georgia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#kazakhstan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#kyrgyzstan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#moldova").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#russia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#ukraine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#uzbekistan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#afghanistan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#bhutan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#iran").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#iraq").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#pakistan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#sriLanka").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#syria").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#greenLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#burundi").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#centralAfricanRep").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#chad").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#congo").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#demRepCongo").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#eritrea").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#ethiopia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#gambia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#liberia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#mauritania").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#nigeria").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#rwanda").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#sierraLeone").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#somalia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#sudan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#togo").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#uganda").style("opacity", noOpacity).style("stroke", noStroke);
        // Update whether or not the elements are active
        blueLine.active = active;
      })
      .text("Latin America/Caribbean");

    // Add the Africa title
    svg.append("text")
      .attr("x", 0)             
      ...
      .on("click", function(){
        ...
        var active   = greenLine.active ? false : true,
          newOpacity = active ? 0.7 : 1,
          newStroke = active ? "grey" : "lawnGreen";
          noOpacity = active ? 0.7 : 0,
          noStroke = active ? "grey" : "white";
        // Hide or show the elements
        d3.select("#greenLine").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#burundi").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#centralAfricanRep").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#chad").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#congo").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#demRepCongo").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#eritrea").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#ethiopia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#gambia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#liberia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#mauritania").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#nigeria").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#rwanda").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#sierraLeone").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#somalia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#sudan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#togo").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#uganda").style("opacity", newOpacity).style("stroke", newStroke);
        // Other countries
        d3.select("#blueLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#honduras").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#haiti").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#cuba").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#redLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#cambodia").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#china").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#indonesia").style("opacity", noOpacity).style("stroke", noStroke);
    ...
    svg.append("text")
      ...
      .on("click", function(){
        ...
        var active   = redLine.active ? false : true,
          newOpacity = active ? 0.7 : 1,
          newStroke = active ? "grey" : "red";
          noOpacity = active ? 0.7 : 0,
          noStroke = active ? "grey" : "white";
        // Hide or show the elements
        d3.select("#redLine").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#cambodia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#china").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#indonesia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#northKorea").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#laos").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#vietnam").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#afghanistan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#bhutan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#iran").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#iraq").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#pakistan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#sriLanka").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#syria").style("opacity", newOpacity).style("stroke", newStroke);
        // Other countries
        d3.select("#orangeLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#azerbaijan").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#belarus").style("opacity", noOpacity).style("stroke", noStroke);
    ...
    svg.append("text")
      ...
      .on("click", function(){
        ...
        var active   = orangeLine.active ? false : true,
          newOpacity = active ? 0.7 : 1,
          newStroke = active ? "grey" : "orange";
          noOpacity = active ? 0.7 : 0,
          noStroke = active ? "grey" : "white";
        // Hide or show the elements
        d3.select("#orangeLine").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#azerbaijan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#belarus").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#georgia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#kazakhstan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#kyrgyzstan").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#moldova").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#russia").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#ukraine").style("opacity", newOpacity).style("stroke", newStroke);
        d3.select("#uzbekistan").style("opacity", newOpacity).style("stroke", newStroke);
        // Other countries
        d3.select("#blueLine").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#honduras").style("opacity", noOpacity).style("stroke", noStroke);
        d3.select("#haiti").style("opacity", noOpacity).style("stroke", noStroke);
