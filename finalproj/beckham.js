...
// Adds the svg canvas
var svg = d3.select("#beckhamchart")
    .append("svg")
...
// Get the data
data = [{movie:"The Man from U.N.C.L.E.",year:2015,rating:67,box_office:45445109},
        {movie:"Goal! The Dream Begins ( Goal!: The Impossible Dream)",year:2005,rating:44,box_office:4283255},
        {movie:"Bend It like Beckham",year:2003,rating:85,box_office:32543449}
      ];
